<?php
	...
	$url = 
"http://webdevrefinery.com/forums/members/?sort_key=posts&sort_order=desc&max_results=60&st=";
...
USER. IF IT CAN'T FIND YOUR USERNAME.
	...
	//finding username and cutting string to start at first 
occurance of it
	...
	$CutToRep = substr($CutToUser, $CutToRepPos + REP_POS_OFFSET, 
5);
